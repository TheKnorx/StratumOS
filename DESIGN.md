...
That leaves 5.3 GiB for the kernel, and 5.3 GiB each for two processes.<br>
This will be replaced by a Bitmap Physical-Memory-Manager (PMM) in the future, which dynamically allocates pages.
